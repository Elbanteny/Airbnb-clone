    ...
    return (
        <>
            <div className="mt-3 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' htmlFor="">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' htmlFor="">
                    <input type="checkbox" checked={selected.includes('kitchen')} name="kitchen" onChange={handleCbClick} /><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
